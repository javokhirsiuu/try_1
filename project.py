...
class MySiuushop:
    ...
    def first_part(self):
        ...
        def second_part_continue():
            money_p = input("please enter how much money you have")
            a1_p = int(input("""from what we will start
                        1)pubg 21$
                        2)kubik rubik 70$
                        3)telefon 890$
                        4)komputer 2000$"""))

            pruducts_price1_p = 21
            pruducts_price2_p = 70
            pruducts_price3_p = 890
            pruducts_price4_p = 2000
            result1_p = int(money_p) - int(pruducts_price1_p)
            result1_againpurchasing_p = int(result1_p) - int(pruducts_price2_p)
            result1_againpurchasing2_p = result1_againpurchasing_p - pruducts_price3_p
            result = int(money_p) - int(pruducts_price3_p)
            result4 = int(money_p) - int(pruducts_price4_p)
            result3 = int(money_p) - int(pruducts_price2_p)
            if a1_p == 1:
                print(f"it is kubik rubik it's price is {pruducts_price1_p}$")
                c2_p = input("are you buying ?:")
                if c2_p == "yes":
                    print(f"{result1_p}$ here you check")
                else:
                    print("bomjara")
            elif a1_p == 2:
                print(f"it is kubik rubik it's price is {pruducts_price2_p}$")
                c2_p = input("are you buying it?:")
                print(c2_p)

                if c2_p == "yes":
                    print(f"{result3}$ you have left")
                    if a1_p == 2:
                        g1 = input(f"it is kubik rubik it's price 70 $")
                        print(c2_p)
                        if c2_p == "yes":
                            print(f"{result3}$ here is your check {name}")
                    if a1_p == 3:
                        print(f"{result1_againpurchasing2_p}$ here is your check we hope that we will see you again")
                ...
                if c2copy == "yes":
                    print("okay")
                    if int(money_p) > int(pruducts_price4_p):
              ...
              print(f"it is komp it's price {pruducts_price4_p}$")
              c2copy = input("are you buying it?:")
              if c2copy == "yes":
                 print("okay")
                 if int(money_p) > int(pruducts_price3_p):
                    print(f"{result4}$ money you have left")
                    data = [name,email,password,money_p]
                    ...
                    with open('names2.csv', 'w', newline='') as csvfile:
                        ...
                        writer.writerow({f'Name': f'{name}', 'Password': f'{password}', 'Email': f'{email}','Money': f'{money_p}'})
                        def part_3():
                            a = int(input("""welcome to our shop
                                    1)registration
                                    2)entering
