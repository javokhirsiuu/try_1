...
with open("result.csv", "w", encoding="utf-8") as file:
    writer = csv.writer(file, delimiter=",")
    writer.writerow([name_entering,email_entering,login])
# name = input("please enter your name:")
...
if a == "1":
    ...
    for x in password:
        if len(x) >= 6 and password_repeating == password:
            ...
            break
    if name == name_entering and email == email_entering and password == login:
        print(f"hello {name}")
        print("we are happy to see you in our shop")
